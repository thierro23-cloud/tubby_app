...
btn_administrar_gestores_bp = Blueprint("btn_administrar_gestores_bp", __name__, url_prefix="/gestores")
        ...
        if accion == "nuevo_gestor":
            ...
            if not nombre or not email:
                ...
                ejecutar_non_query(
                    ...
                    (nombre, apellido1, apellido2, email, password, dni, telefono, extension, numero_profesional, idtbl_provincias, idtbl_municipios, idtbl_tipos_de_vias, idtbl_calles, idtbl_roles, activo, must_change),
                    "bd_tbl_comunes"
                )
            ...
            if password:
                ejecutar_non_query(
                    ...
                    (nombre, apellido1, apellido2, email, password, dni, telefono, extension, numero_profesional, idtbl_provincias, idtbl_municipios, idtbl_tipos_de_vias, idtbl_calles, idtbl_roles, activo, must_change, idtbl_gestores),
                    "bd_tbl_comunes"
                )
            else:
                ejecutar_non_query(
                    ...
                    (nombre, apellido1, apellido2, email, dni, telefono, extension, numero_profesional, idtbl_provincias, idtbl_municipios, idtbl_tipos_de_vias, idtbl_calles, idtbl_roles, activo, must_change, idtbl_gestores),
                    "bd_tbl_comunes"
                )
